...
{ 
 ...
 if(request.getParameter("delete")!=null)
 {
  ...
  String subject=request.getParameter("delete");
  
  PreparedStatement pstmt=null; //create statement
  
  pstmt=con.prepareStatement("delete from marks where  Id=? && Subject=?"); //sql delete query
...
<body bgcolor="white">
  ...
  %>
    ...
    <td> <a href="?delete=<%=rs.getString(3)%> ">Delete</a> </td>
