...
public final class viewjsp2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
{ 
 ...
 if(request.getParameter("delete")!=null)
 {
  ...
  pstmt=con.prepareStatement("delete from data where email=? "); //sql delete query
...
catch(Exception e)
{
 out.println(e);
      ...
      out.write("                    \n");
      out.write("\n");
      out.write("                    <h2 class=\"title\"><h1><p>List OF Admin</p></h1></h2>\n");
      out.write("                </div>\n");
  ...
  { 
   ...
   pstmt=con.prepareStatement("select * from data"); //sql select query 
