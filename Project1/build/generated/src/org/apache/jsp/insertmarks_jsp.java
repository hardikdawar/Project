...
{ 
 ...
 if(request.getParameter("delete")!=null)
 {
  ...
  pstmt=con.prepareStatement("delete from marks where Id=? "); //sql delete query
...
int i=st.executeUpdate("insert into marks(Id,name,subject,marks,password)values('"+Id+"','"+name+"','"+sub+"','"+mark+"','"+pass+"')");
...
e.printStackTrace();
      ...
      out.write("    <title>Enter marks of Students</title>\n");
      out.write("\n");
      ...
      out.write("                    \n");
      out.write("\n");
      out.write("                    <h2 class=\"title\"><h1><p>List OF Students</p></h1></h2>\n");
      out.write("                </div>\n");
  ...
  { 
   ...
   pstmt=con.prepareStatement("select * from marks where subject='"+sub+"'"); //sql select query 
