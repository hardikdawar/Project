...
public final class displaymarks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  { 
   ...
   pstmt=con.prepareStatement("select * from marks where Id='"+Id+"' && password='"+pass+"'"); //sql select query 
