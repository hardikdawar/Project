...
public final class viewjsp1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
{ 
 ...
 if(request.getParameter("delete")!=null)
 {
  ...
  pstmt=con.prepareStatement("delete from data2 where email=? "); //sql delete query
...
catch(Exception e)
{
 out.println(e);
      ...
      out.write("                    \n");
      out.write("\n");
      out.write("                    <h2 class=\"title\"><h1><p>List OF Teachers</p></h1></h2>\n");
      out.write("                </div>\n");
      ...
      out.write("    <th>confirm_Password</th>\n");
  ...
  { 
   ...
   pstmt=con.prepareStatement("select * from data2"); //sql select query 
